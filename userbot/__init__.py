...
if Config.TAG_LOGGER == 0:
    if gvarstatus("TAG_LOGGER") is None:
        Config.TAG_LOGGER = -100
    else:
        Config.TAG_LOGGER = int(gvarstatus("TAG_LOGGER"))
elif str(Config.TAG_LOGGER)[0] != "-":
    Config.TAG_LOGGER = int("-" + str(Config.TAG_LOGGER))
